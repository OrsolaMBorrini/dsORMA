...
def readCSV(path):
    ...
    JA_df = JA_df.rename(columns={'id':'doi'})
    print(JA_df.columns)
    ...
    BC_df = BC_df.rename(columns={'id':'doi'})
    # print(BC_df.head(3))
    print(BC_df.columns)
    ...
    PP_df = PP_df.rename(columns={'id':'doi'})
    # print(PP_df.head(3))
    print(PP_df.columns)
    ...
    VeB_df = VeB_df.rename(columns={'id':'doi','publisher':'crossref'})
    ...
    VeJ_df = VeJ_df.rename(columns={'id':'doi','publisher':'crossref'})
    ...
    VePE_df = VePE_df.rename(columns={'id':'doi','publisher':'crossref'})
